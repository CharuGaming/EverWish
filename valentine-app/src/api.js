...
export function toComponentData(doc) {
  ...
  return {
    ...
    birthday: {
      ...
      introVideoUrl:   doc.birthday?.introVideoUrl   || doc.introVideoUrl || '',
      gatekeeperBgColor: doc.birthday?.gatekeeperBgColor || '#fdf2f8',
      gatekeeperButtonText: doc.birthday?.gatekeeperButtonText || 'Tap to Open 🎁',
      bgVideoUrl:      doc.birthday?.bgVideoUrl || doc.bgVideoUrl || '',
    },
    customModules: {
    ...
    cinematic: doc.cinematic ? {
      ...
      bucketList: (doc.cinematic.bucketList || []).map((b, i) => ({
        id:          b._id || b.id || i,
        item:        b.item        || '',
        isCompleted: b.isCompleted ?? false,
      })),
      specialLocations: (doc.cinematic.specialLocations || []).map((s, i) => ({
        id:          s._id || s.id || i,
        title:       s.title       || '',
        description: s.description || '',
        imageUrl:    s.imageUrl    || '',
      })),
      voiceNoteUrl:    doc.cinematic.voiceNoteUrl    || '',
      funFacts: (doc.cinematic.funFacts || []).map((f, i) => ({
        id:       f._id || f.id || i,
        question: f.question || '',
        answer:   f.answer   || '',
      })),
      openWhenLetters: (doc.cinematic.openWhenLetters || []).map((o, i) => ({
        id:        o._id || o.id || i,
        condition: o.condition || '',
        message:   o.message   || '',
        imageUrl:  o.imageUrl  || '',
      })),
      videoMontageUrl: doc.cinematic.videoMontageUrl || '',
      partnerWhatsApp: doc.cinematic.partnerWhatsApp || '',
    } : null,
    ...
    bday6: doc.bday6 ? {
      heroBadge:           doc.bday6.heroBadge || '',
      heroTitle:           doc.bday6.heroTitle || '',
      heroSubtitle:        doc.bday6.heroSubtitle || '',
      scrollText:          doc.bday6.scrollText || '',
      giftSectionTitle:    doc.bday6.giftSectionTitle || '',
      giftSectionSubtitle: doc.bday6.giftSectionSubtitle || '',
      giftUnwrapText:      doc.bday6.giftUnwrapText || '',
      yearRecapIcon:       doc.bday6.yearRecapIcon || '',
      yearRecapTitle:      doc.bday6.yearRecapTitle || '',
      bucketListIcon:      doc.bday6.bucketListIcon || '',
      bucketListTitle:     doc.bday6.bucketListTitle || '',
      bucketListSubtitle:  doc.bday6.bucketListSubtitle || '',
      songSectionTitle:    doc.bday6.songSectionTitle || '',
      songSectionSubtitle: doc.bday6.songSectionSubtitle || '',
      noMusicText:         doc.bday6.noMusicText || '',
      gallerySectionIcon:  doc.bday6.gallerySectionIcon || '',
      gallerySectionTitle: doc.bday6.gallerySectionTitle || '',
      gallerySectionSubtitle: doc.bday6.gallerySectionSubtitle || '',
      footerText:          doc.bday6.footerText || '',
    } : null,
    passcode: doc.passcode ? {
      title: doc.passcode.title || '',
      hint: doc.passcode.hint || '',
      targetPasscode: doc.passcode.targetPasscode || '',
      videoUrl: doc.passcode.videoUrl || '',
    } : null,
    customTitles: {
...
export function emptyTemplate(siteId, templateType = 'polaroid', category = 'valentine') {
  return {
    ...
    bday6: {
      ...
      heroSubtitle:        'A cinematic celebration...',
      scrollText:          'Scroll down',
      giftSectionTitle:    'A Special Gift',
      giftSectionSubtitle: 'Just for you',
      giftUnwrapText:      'Tap to Unwrap',
      yearRecapIcon:       '✨',
      yearRecapTitle:      'Year in Review',
      bucketListIcon:      '📝',
      bucketListTitle:     'Bucket List',
      bucketListSubtitle:  'Things to do this year',
      songSectionTitle:    'Our Song',
      songSectionSubtitle: 'Listen to the melody',
      noMusicText:         'No song selected',
      gallerySectionIcon:  '📸',
      gallerySectionTitle: 'Memories',
      gallerySectionSubtitle: 'Captured moments',
