...
class Media {
  ...
  update(scroll, direction) {
    ...
    const currentBend = this.screen.width < 768 ? (this.bend === 0 ? 0 : Math.sign(this.bend) * Math.min(Math.abs(this.bend), 1.5)) : this.bend;
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.scale = isMobile ? this.screen.width / 1000 : this.screen.height / 1500;
